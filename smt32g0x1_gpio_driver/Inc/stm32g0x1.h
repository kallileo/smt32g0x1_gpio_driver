...
#define SRAM_BASE					0x200000000U //Base address to SRAM1 (Size: 1)
 ...
 */
#define SYSCFG_PCLK_ENBL()		(RCC->APB2ENR |= ( 1 << 14 ))
 ...
 */
#define SYSCFG_PCLK_DSBL()		(RCC->APB2ENR &= ~(1 << 14))
...
#define GPIO_BASE_TO_CODE(addr)		( (addr==GPIOA) ? 0 :\
										(addr==GPIOB) ? 1 :\
										(addr==GPIOC) ? 2 :\
										(addr==GPIOD) ? 3 :\
										(addr==GPIOE) ? 4 :\
